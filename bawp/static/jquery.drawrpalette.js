    ...
    $.fn.drawrpalette = function( action, param ) {
		...
		this.each(function() {
			...
			if ( action === "destroy") {
                ...
                currentPicker.$dropdown.append('<div style="height:28px;text-align:right;margin-top:-2px;padding:0px 5px;"><button style="width: 100%;color: rgb(0, 0, 0);margin: 0 10px 0 0;" class="ok">OK</button></div>');
                ...
                if($(this).val()!==""){
                    ...
                    var hsv = plugin.rgb_to_hsv(255,255,255);
                    currentPicker.hsv = hsv;
